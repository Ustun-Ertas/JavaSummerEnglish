...
public class DataTypes02 {
    public static void main(String[] args) {
        ...
        //Every character has an integer value of IT area. Those values are called  ASCII values
        //Note: If you use any char in mathematical operation. Java uses its ASCII Value int the operation
        ...
        /*
        When you use different data types in mathematical operations the result will be in the largest data types.
        ...
        //What is the output of followings?
